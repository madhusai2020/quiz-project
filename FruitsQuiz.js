...
export default function MoviesQuiz(props) {
    return (
        ...
        <View style={{justifyContent:"center", alignItems:"center"}}>
            ...
            <Text style={{textDecorationLine:"underline", fontWeight:"bold", fontSize:40, marginLeft:40, marginBottom:20, marginLeft:50}}>Fruits Quiz:</Text>
        </View>
        ...
        <Text style={{fontSize:20, marginLeft:20, marginBottom:40}}>-- Getting every answer correct will getmore points. So try to answer everything correctly. Good Luck and try your best!</Text>
