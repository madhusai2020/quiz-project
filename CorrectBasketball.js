...
export default function CorrectBasketball(props) {
  ...
  backgroundColor:"#013220"}} ><Text style={{color:"white", textAlign:"center", fontWeight: 'bold', fontSize:40}} onPress= {()=>{props.navigation.navigate(  PScreenNameBasketball, {data1:PScoreBasketball})}} >Next -{'>'}</Text></TouchableOpacity>
