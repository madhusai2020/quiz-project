...
export default function Quizzes(props) {
    return (
        ...
        <View style={{justifyContent:"center", alignItems:"center"}}>
            ...
            <Image style={{width:500, height:350, borderRadius:10, marginLeft:40, marginTop:10, justifyContent:'center', alignItems:"center", marginBottom:30}} source={{uri:"https://images.pexels.com/photos/1921326/pexels-photo-1921326.jpeg?cs=srgb&dl=pexels-markus-spiske-1921326.jpg&fm=jpg"}}></Image>
            <Text style={{textDecorationLine:"underline", fontWeight:"bold", fontSize:40, marginLeft:40, marginBottom:20, marginLeft:50}}>Coding Quiz:</Text>
        </View>
