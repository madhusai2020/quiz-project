...
export default function WrongScreenMath(props) {
  ...
  backgroundColor:"pink"}} ><Text style={{color:"black", textAlign:"center",  fontSize:40, fontWeight:90}} onPress= {()=>{props.navigation.navigate(PScreenNameMath, {data1:PScoreMath})}} >Next -{'>'}</Text></TouchableOpacity>
