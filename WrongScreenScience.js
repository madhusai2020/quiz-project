...
export default function WrongScreenScience(props) {
  ...
  backgroundColor:"pink"}} ><Text style={{color:"black", textAlign:"center",  fontSize:40, fontWeight:90}} onPress= {()=>{props.navigation.navigate(PScreenNameScience, {data1:PScoreScience})}} >Next -{'>'}</Text></TouchableOpacity>
