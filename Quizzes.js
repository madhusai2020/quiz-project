...
export default function Quizzes(props) {
    return (
        ...
        <View style={{justifyContent:"center", alignItems:"center"}}>
            ...
            <Image style={{width:500, height:350, borderRadius:10, marginLeft:40, marginTop:10, justifyContent:'center', alignItems:"center"}} source={{uri:"https://cdn.britannica.com/73/2573-004-29818847/Flag-Mexico.jpg"}}></Image>
