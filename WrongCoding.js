...
export default function WrongCoding(props) {
  ...
  backgroundColor:"pink"}} ><Text style={{color:"black", textAlign:"center",  fontSize:40, fontWeight:90}} onPress= {()=>{props.navigation.navigate(PScreenNameCoding, {data1:PScoreCoding})}} >Next -{'>'}</Text></TouchableOpacity>
